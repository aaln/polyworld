POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                                                  'claim': 'The verified recorded Druid kept walking home '
                                                           ...
                                                           'gate. The user requests a simpler lane-healing '
                                                           'policy with useful shopping returns.',
                       ...
                       'RecoveryMechanism': {'status': 'supported',
                                             'claim': 'All 92 actual-tick recovery fixtures, 100 opening '
                                                      ...
                                                      'broad checks pass; 16 complete native games pass. '
                       ...
                       'CompetitiveGain': {'status': 'contradicted',
                                           'claim': 'The frozen 320-game qualification rule was met: False. '
                                                    'Aggregate mean score change -5.256%, 95% gain interval '
                                                    '[-20.508983749141674, 12.252202445486326]; context '
                                                    'changes [-2.7539774776579984, -12.150972462930865, '
                                                    '25.450521656655066, 25.34946706272936]. Druid exposure '
                                                    "{'baseline': 66, 'lane-recovery': 71}. This decision "
                                                    'applies to the frozen four-context roster and complete '
                                                    'candidate; it does not establish universal ranking, '
                                                    'certain population harm on rejection, or the causal '
 ...
 'goal': {'Win': {'preference': 'No independent victory incentive. Enemy-god destruction supplies500 own XP '
          ...
          'Practice': {'preference': 'Secure feasible last hits and shared XP, buy useful permanent power, '
                       ...
                       'provenance': 'authored'},
          'survive_and_replenish': {'preference': 'Stay near the current lane while useful healing can '
                                                  'safely recover a health-only retreat. Return for an '
                                                  'affordable missing core item, absent healing or danger. '
                                                  'Resume farming at60%HP/20%mana; hold at most12seconds.',
                                    'provenance': 'interpretation'}},
 'skill': {'portal_state': {'operator': 'lane_portal_state', 'parameters': {}},
           'draft': {'operator': 'lane_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'lane_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'lane_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'lane_timing', 'parameters': {}},
           'lifecycle': {'operator': 'lane_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'lane_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'lane_economy', 'parameters': {'shop_gold': 500}},
           'portal_context': {'operator': 'lane_portal_context', 'parameters': {}},
           'lane_recovery': {'operator': 'lane_lane_recovery', 'parameters': {}},
           'replenish': {'operator': 'lane_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'lane_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'lane_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'lane_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'lane_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'lane_xp_close', 'parameters': {}},
           'combat': {'operator': 'lane_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'lane_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/lane-recovery-2026-09-23-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 3,
            'parent': '2dde8d84cac98a28eecc71bafe26837254302508fec65a3761e27ca6e16180fe',
