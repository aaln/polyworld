POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_selective_finish59_20260923',
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'regeneration is assumed. SelectiveFinish: visible living enemy heroes/creeps remain '
                        'eligible; exposed nearby towers/god require <=two current basic hits of HP, '
                        'barracks <=one; one-hit tower/barracks gets +300 target score. Buildings remain '
                        'observations for safety and navigation; hidden XP and opponent identity are never '
                        'live inputs.'},
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'RecoveryMechanism': {'status': 'supported',
                                             'claim': 'The inherited Druid recovery behavior previously '
                                                      'passed its own scoped study. For this '
                                                      'target-selection source, 92 recovery, 100 opening, '
                                                      '180 buyback, 84 portal and 126 broader host checks '
                                                      'pass again on replay59; 16 complete responsive native '
                                                      'matches validate runtime. The separate 220 '
                                                      'target/kill fixtures validate the new eligibility '
                                                      'rule. Prior non-Druid command-equivalence claims '
                                                      'describe the Druid parent change, not this all-class '
                       ...
                       'CompetitiveGain': {'status': 'contradicted',
                                           'claim': 'Frozen400game qualification passed=False. Mean '
                                                    'score1540.300→1512.315, '
                                                    'gain-1.817%,95%gainCI[-16.5290232015061, '
                                                    '14.353619145499907]; context gains[-16.215517848893203, '
                                                    '11.67376613582669, 339.5626242544731, '
                                                    '-63.37123084527929]. Productivity metrics and field '
                                                    'drift recorded in trial-report. '
                       ...
                       'SelectiveFinish': {'status': 'supported',
                                           'claim': 'All 220 target/kill fixtures plus582 inherited checks '
                                                    'and16 native games pass on replay59. In the32-game '
                                                    'preselected diagnostic subset, candidate '
                                                    'building-target commands=3; commands exceeding the '
                                                    'pre-tick two-hit limit or the one-hit barracks limit=0. '
                                                    'Fixture kills yield100building or500god XP. '
                                                    'Selection/acceptance evidence is distinct from '
                                                    'competitive value.',
                                           'evidence': [{'artifact': 'evidence/local-summary.json'},
                                                        {'artifact': 'evidence/effects-summary.json'}]}}},
 'goal': {'Win': {'preference': 'Permit a nearby two-hit god finish for500XP per teammate and a two-hit '
                                'tower finish for100XP. Barracks require one hit because destruction removes '
                                'future waves. Preserve lethal-unit priorities and measure opportunity cost '
                                'after elapsed time.',
                  'provenance': 'authored'},
 ...
 'skill': {'portal_state': {'operator': 'finish_portal_state', 'parameters': {}},
           'draft': {'operator': 'finish_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'finish_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'finish_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'finish_timing', 'parameters': {}},
           'lifecycle': {'operator': 'finish_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'finish_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'finish_economy', 'parameters': {'shop_gold': 500}},
           'portal_context': {'operator': 'finish_portal_context', 'parameters': {}},
           'lane_recovery': {'operator': 'finish_lane_recovery', 'parameters': {}},
           'replenish': {'operator': 'finish_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'finish_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'finish_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'finish_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'finish_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'finish_xp_close', 'parameters': {}},
           'combat': {'operator': 'finish_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'finish_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/selective-finish-2026-09-23-r59',
               'game_version': '2026.9.23.1',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '6465c43d69ad0f93b70d91cce47d50f5574b6a2e2adcf56b61a6257dc61bb8a0',
