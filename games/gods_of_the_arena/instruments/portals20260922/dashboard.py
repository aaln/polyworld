...
STUDY = Path(__file__).resolve().parents[5] / 'polyworld/tmp/gota-portals-20260922'
PAGE = '''<!doctype html><meta charset="utf-8"><title>GOTA portal and khors tests</title>
...
<h1>GOTA — portal policy vs khors:v114</h1><p class="note">2026.9.22.2 · 40 games per source and color · XP score is primary</p>
...
def data():
    ...
    for name in ('baseline', 'candidate'):
        for side in (0, 1):
            p = STUDY / 'hosted-khors114' / name / str(side)
...
if __name__ == '__main__':
    ThreadingHTTPServer(('127.0.0.1', 8851), Handler).serve_forever()
