...
OUT=ROOT/'examples/gods_of_the_arena/players/ir/forks/core-buyback20260923'
...
def main():
    ...
    shutil.copy2(ROOT/'games/gods_of_the_arena/experiments/2026-09-23-core-buyback.md',OUT/'evidence/experiment.md')
    ...
    for entry in trial['candidates']:
        ...
        p['belief']['claims']['OpportunityMechanism'].update(status='supported',claim='All180 actual-tick buyback scenes pass across ten classes and both colors. Baseline separately satisfies180 expectations for its original behavior. Eight full native games pass runtime/replay/XP checks. This validates immediate buyback cost/resource restoration, cooldown preservation and core/time/reserve guards, not comparative rival score.',evidence=[{'artifact':'evidence/practice.json'}])
