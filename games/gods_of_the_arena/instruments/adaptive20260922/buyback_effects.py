...
def main():
    ...
    definition={'selection':'First4 lexical episode UUIDs per cell after all cells complete; rule chosen before detailed effect decoding. Retrospective diagnostic subset, no independent holdout/competitive gate.','cases':cases,'instrument_sha256':sha(Path(__file__).with_name('buyback_effect_audit.nim')),'binary_sha256':sha(STUDY/'buyback-effect-audit')}
