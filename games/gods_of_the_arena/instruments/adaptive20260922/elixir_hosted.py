"""One preselected combat-elixir versus 400 fresh held-out games."""
...
h.CYCLE='interactive-combat-elixir-20260923'
base.LABELS=['combat-elixir'];base.CONFIRM_SUBJECT=0;base.GAMES=100;base.REQUEST_PREFIX='gota-elixir0923'
...
base.NOTES_OVERRIDE=base.RULE_OVERRIDE+' Exact Richard167 and khors114 opposing both colors. Public-only instant combat elixirs and bounded gold reserves. No automatic league selection.'
...
def upload(c,label):
    ...
    meta={'name':'aaron-gota-elixir0923-'+label,'content_hash':digest,'size_bytes':len(data),'player_id':h.PLAYER,'attributes':{},'tags':{'game':'gods_of_the_arena','game_version':h.VERSION,'engine_commit':h.COMMIT,'validation':'240 actual-tick consumable healing/economy cases;84portal+126broad cases;8complete native games;portable IR equality. Inert; competitive score unvalidated.'}}
...
def prepare(stage):
    ...
    base.prepare(stage,'combat-elixir')
