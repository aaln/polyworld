...
<h1>GOTA — adaptive score comparison</h1><p class="note">2026.9.22.3 · 40 games per source and color · XP score is primary</p>
...
def data():
    ...
    for arm in plan['arms']:
        ...
        result.append({'name':study.name.replace('gota-','')+' / '+stage+' / '+name,'side':side,
