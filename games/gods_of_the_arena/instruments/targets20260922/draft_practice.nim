## Real-host draft regression from ereq_cd49a7f0; no future replay actions.
import std/[os, json]
import bassy
...
var rows = newJArray()
for first in [Crossbowman, Ranger]:
  ...
  doAssert subject.class == (if first == Crossbowman: Ranger else: Arcanist)
