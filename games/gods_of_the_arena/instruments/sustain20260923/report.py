...
import sustain_hosted as study
...
def build(stage):
    ...
    assert stage=='trial' and plan['games']==240 and len(plan['arms'])==6 and all(a['games']==40 for a in plan['arms'])
    ...
    for name,after in by.items():
        ...
        for _ in range(10000):
            ...
            b,n=mean(draw[:3]),mean(draw[3:]);gains.append((n/b-1)*100 if b else 0)
        gains.sort()
