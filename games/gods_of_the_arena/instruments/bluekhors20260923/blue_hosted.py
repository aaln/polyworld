...
h.CYCLE='interactive-blue-center-20260923'
base.BASELINE='30a0e469-8c2f-450c-b3bc-4a687a6c74e3'
base.PARENT=ROOT/'examples/gods_of_the_arena/players/ir/forks/core-buyback20260923/core-buyback'
base.LABELS=['blue-center'];base.CONFIRM_SUBJECT=0;base.GAMES=100;base.REQUEST_PREFIX='gota-bluecenter0923'
base.RULE_OVERRIDE='One preselected source;400fresh games,100/source/color. Zero invalid and all10source/VM/replay/XP/integer audits; aggregate mean gain>=10%, each color>=95% control, positive lower95% side-stratified whole-game bootstrap gain bound. Blue mean must improve with positive lower95%gain bound; mean blue own-minus-khors114 must be positive. No screening/control reuse. Game and principal champion versions must remain unchanged; background changes disclosed. Fixed first-seat mixed roster; no universal rank or late-draft claim.'
base.BUDGET_OVERRIDE='Normal Sep23UTC1600; shared ledger,one400-game cycle,parallel3,batch100. No additional stage.'
base.NOTES_OVERRIDE=base.RULE_OVERRIDE+' Exact Richard174 and khors114 opposing both colors. Public blue lead-ranged central routing. No automatic league selection.'
...
def upload(c,label):
    ...
    meta={'name':'aaron-gota-bluecenter0923-'+label,'content_hash':digest,'size_bytes':len(data),'player_id':h.PLAYER,'attributes':{},'tags':{'game':'gods_of_the_arena','game_version':h.VERSION,'engine_commit':h.COMMIT,'validation':'100 opening guards,180 inherited buyback,84 portal,126 broad cases;8 complete native games;portable IR equality. Inert; competitive score unvalidated.'}}
...
def prepare(stage):
    ...
    base.prepare(stage,'blue-center')
