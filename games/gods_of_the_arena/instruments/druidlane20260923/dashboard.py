...
STUDY = Path(__file__).resolve().parents[5] / 'polyworld/tmp/gota-druid-lane-20260923'
...
<h1>GOTA — Druid lane recovery comparison</h1><p class="note">2026.9.22.3 · Fresh controls in both colors · XP score is primary</p>
...
if __name__ == '__main__':
    ThreadingHTTPServer(('127.0.0.1', 8857), Handler).serve_forever()
