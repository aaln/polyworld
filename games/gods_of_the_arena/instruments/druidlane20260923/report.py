...
def build(stage):
    ...
    for entry in candidates:
        ...
        entry['non_druid_equivalence']=h.read(STUDY/'non-druid-equivalence.json')['passed'] and h.read(STUDY/'ranged-equivalence.json')['passed']
        entry['score_gate_passed']=entry['score_gate_passed'] and min(exposure.values())>=20 and entry['non_druid_equivalence']
