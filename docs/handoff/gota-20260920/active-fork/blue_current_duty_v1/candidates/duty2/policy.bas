' Generated from autoresearch_blue_current_duty2_v1; gota-semantic-policy/1; gota-basic/1
...
if selfTeam = 0 then
  ...
  responseRank = 0
  responseIndex = 0
  while responseIndex < observedObjectCount and responseIndex < 64 and responseRank < 2
  ...
  wend
  if responseMode and responseRank >= 2 then
    responseUntil = 0
    responseMode = 0
    defUntil = 0
  end if
