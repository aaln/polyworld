' Generated from autoresearch_20260920_handoff; gota-semantic-policy/1; gota-basic/1
...
if objectCount() > defMotionLimit then
  motionActive = 0
  if bestId <> 0 and selfClass <> 9 and (selfLevel >= 2 or (0 > 0 and selfAttacksLanded >= 0) or (0 = 1 and defActive = 0)) then
