' Generated from autoresearch_20260920_middle_warlock_v1_cached_v2; gota-semantic-policy/1; gota-basic/1
...
if bestId = 0 and motionActive = 0 then
  if selfTeam = 0 and selfClass = 8 and worldTick <= 1800 and defActive = 0 then
    moId = 0
    moX = 105
    moY = 10
    moI = 0
