' Generated from gota_support_restore_unanchored; gota-semantic-policy/1; gota-basic/1
...
if selfTeam = 0 then
  ...
  if defFront <> 0 and aaDistance <= 22 * 22 then
    ...
    while aaI < objectCount() and aaI < 64
      ...
      aaI = aaI + 1
    wend
    if aaCommitted and selfHp * 100 >= selfMaxHp * 25 and (1 = 0 or bestId = 0)  and (0 = 0 or defAnchor <> 0) then
      bestId = defFront
