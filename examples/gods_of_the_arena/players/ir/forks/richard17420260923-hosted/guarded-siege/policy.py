POLICY = {'schema': 'gota-semantic-policy/1',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'RecoveryMechanism': {'status': 'supported',
                                             'claim': 'The inherited Druid recovery component is '
                                                      ...
                                                      'This coordinated siege source changes non-Druid '
                                                      'target selection, so prior whole-policy non-Druid '
                       ...
                       'CompetitiveGain': {'status': 'contradicted',
                                           'claim': 'The frozen400-game qualification rule was met: False. '
                                                    'Pooled mean score change 7.577%,95%gain interval '
                                                    '[-8.650446677910429, 27.054058522069766],context '
                                                    'changes [3.24869787245603, 4.846182856527115, '
                                                    '-53.15045719035745, 55.88104140225707]. This result '
                                                    'applies to one complete coordinated source and four '
                                                    'fixed-roster contexts. Rejection is failure to qualify, '
                                                    'not proof of population harm. It establishes neither a '
                                                    'universal ranking nor single-component causality.',
                       ...
                       'RichardSourceTransfer': {'status': 'supported',
                                                 'claim': 'Richard source identity and ordering are verified '
                                                          ...
                                                          'opportunities. New target selection passes80 '
                                                          'actual-host scenes on four classes and both '
                                                          'colors, together with582 inherited checks and16 '
                                                          'complete native matches. Source identity, runtime '
                                                          'and intended guarded choices are supported; '
                                                          'competitive value of the coordinated transfer '
                                                          'remains unvalidated. Hosted mechanism audit '
                                                          'reconstructs all commands and state hashes '
                                                          'in32prospectively selected games; candidate '
                                                          "totals {'selected_covered_tower': 149, "
                                                          "'submitted_attack_covered_tower': 44, "
                                                          "'selected_siege_attacker': 2, "
                                                          "'submitted_attack_siege_attacker': 2}. Selections "
 ...
 'execution': {'binding': 'gota-bassy/guarded-siege-2026-09-23-r2',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 3,
            'parent': 'f1926b00764488c758b0c758c4db6d6674b8d77398bfa06a8bd31876ec262473',
