POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'OpportunityMechanism': {'claim': 'All180 actual-tick buyback scenes pass across ten '
                                                         'classes and both colors. Baseline separately '
                                                         'satisfies180 expectations for its original '
                                                         'behavior. Eight full native games pass '
                                                         'runtime/replay/XP checks. This validates immediate '
                                                         'buyback cost/resource restoration, cooldown '
                                                         'preservation and core/time/reserve guards, not '
                                                         'comparative rival score.',
                                                'status': 'supported',
                       ...
                       'CompetitiveGain': {'claim': '400-game fresh held-out trial passed: 30.184% '
                                                    'aggregate, colors [22.97206626357353, '
                                                    '39.78661354254378],95% interval [16.096293942450224, '
                                                    '46.53996509682161]. Gate requires >=10%aggregate, '
                                                    '>=95%eachcolor and positive lower95%bound, zero '
                                                    'invalid. Game/principal-stable deployment '
                                                    'qualification: True. Exact-version fixed first-seat '
                                                    'roster only; no future rank or late-draft claim.',
                                           'status': 'supported',
 ...
 'skill': {'portal_state': {'operator': 'buyback_portal_state', 'parameters': {}},
           'draft': {'operator': 'buyback_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'buyback_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'buyback_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'buyback_timing', 'parameters': {}},
           'lifecycle': {'operator': 'buyback_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'buyback_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'buyback_economy', 'parameters': {'shop_gold': 500}},
           'portal_context': {'operator': 'buyback_portal_context', 'parameters': {}},
           'replenish': {'operator': 'buyback_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'buyback_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'buyback_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'buyback_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'buyback_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'buyback_xp_close', 'parameters': {}},
           'combat': {'operator': 'buyback_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'buyback_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/core-buyback-2026-09-23-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'f0c81ccd1d250a4b10452983e23055ed5d928e5e6921509a135eafa9f7fd5be5',
