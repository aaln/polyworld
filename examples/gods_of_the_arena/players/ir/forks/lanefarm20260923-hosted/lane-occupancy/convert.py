"""Convert the lane occupancy semantic policy through its frozen binding."""
import argparse
import json
...
sys.path.insert(0, str(pair / 'tooling/lanefarm20260923'))
import occupancy_binding
occupancy_binding.configure()
ir = occupancy_binding.ir
