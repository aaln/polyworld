POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'interrupts; a bot cannot cancel a channel by walking. Public one-hit target '
                        'finishes ordered by current direct XP reward; original long-range/general target '
                        'and recovery paths; no hidden player identity or lifetime-XP input. Own lifetime XP '
                        'is not exposed by this host BASIC API.'},
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'OpportunityMechanism': {'claim': 'All140 actual-tick target/reward scenes pass '
                                                         'across ten classes and both colors; the baseline '
                                                         'satisfies80/140 of these new expectations. Eight '
                                                         'full native games pass runtime/replay/XP checks. '
                                                         'This validates reachable-finish priorities and '
                                                         'negative guards, not comparative rival score.',
                                                'status': 'supported',
                       ...
                       'CompetitiveGain': {'claim': 'Initial400games passed score gate '
                                                    '(+12.438%,CI[0.084,26.409]) but failed all-field '
                                                    'stability. 160-game fresh background-roster '
                                                    'confirmation failed: -2.297% aggregate, colors '
                                                    '[3.2573653061793273, -9.321894464684455],95% interval '
                                                    '[-17.59214526573656, 15.593064042628924]. Gate requires '
                                                    '>=10%aggregate, >=95%eachcolor and zero invalid; '
                                                    'initial400game gain bound positive. '
                                                    'Game/principal-champion stability qualification: False. '
                                                    'Exact-version fixed first-seat roster only; no future '
                                                    'rank or late-draft claim.',
                                           'status': 'contradicted',
                       ...
                       'FieldDrift': {'status': 'supported',
                                      'claim': 'Opponent-version and game snapshots are evaluation metadata; '
                                               ...
                                               'or hidden replay state enters the live source. '
                                               'Principal-player or game changes prevent this confirmation '
                                               'deployment; other background changes are reported and exact '
                                               'tested-version scope is preserved.',
 ...
 'execution': {'binding': 'gota-bassy/reward-finish-2026-09-22-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '928ded9658b2e9c1102d063e6a3577b327bf67e07adfcebeef43c86f78dbd5da',
