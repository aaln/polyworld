' Generated from gota_portal_coaching20260922; gota-semantic-policy/1; gota-bassy/portals-2026-09-22-r2
...
if drafting = 0 and selfHp > 0 and selfChannelTicks = 0 and selfStunTicks = 0 and canShop() = 0 and selfHp * 100 < selfMaxHp * 30 then
  if retreat = 0 then
    active = 1
  end if
  retreat = 1
...
if drafting = 0 and selfHp > 0 and selfChannelTicks = 0 and canShop() = 1 and selfHp * 100 < selfMaxHp * 30 then
  retreat = 1
  resumeTarget = 0
end if
