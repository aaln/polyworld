...
def run(case):
    ...
    source=ROOT/'examples/gods_of_the_arena/players/ir/forks/blue-center20260923-hosted/blue-center/policy.bas' if label=='baseline' else STUDY/label/'policy.bas'
