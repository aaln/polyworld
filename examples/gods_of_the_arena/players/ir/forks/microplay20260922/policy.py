"""Practiced semantic policy; claims are scoped to preserved evidence."""
...
POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'PracticeMechanics': {'claim': 'Controlled both-color engine drills: Ranger 20 to 39 '
                       ...
                       'TargetFortImprovement': {'claim': 'No target/color fort-win regression versus '
                                                          'lane:v1 and positive aggregate win gain.',
                                                 'status': 'supported',
                                                 'evidence': [{'artifact': 'evidence/review.json'}]},
                       'TargetQualification': {'claim': 'All six cells achieve >=30/40 fort wins and own '
                                                        'score strictly above and >=1.10x rival mean. Fort '
                                                        'gate: False; score gate: False.',
                                               'status': 'contradicted',
                                               'evidence': [{'artifact': 'evidence/practiced/plan.json'},
                                                            {'artifact': 'evidence/practiced/result.json'}]},
                       'Generalization': {'claim': 'Current evidence does not establish mixed-team '
                                                   'superiority, current successors, a #1 rank, or general '
                                                   'per-component causality. Draft reactions are public; '
                                                   'target identities are evaluation metadata only.',
 ...
 'execution': {'binding': 'gota-bassy/microplay-2026-09-22-r2',
               ...
               'language': 'BASIC'},
 'update': {'revision': 4,
            'parent': '4e373db57442217ff54806146ae58338a69ef19cc9f22b420d89cf3ef4b2ef81',
            'change': {'origin': 'Completed user-requested micropractice and six-cell hosted target '
                                 'comparison; retained evaluated BASIC exactly',
                       'source': 'User: practice last hitting, optimizing XP, item upgrades and town '
                                 'portals'},
            'needs_review': ['belief/Generalization', 'belief/TargetQualification'],
