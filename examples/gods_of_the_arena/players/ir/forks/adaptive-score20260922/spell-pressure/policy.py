POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_adaptive_spell_pressure',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'OpportunityMechanism': {'claim': 'All44 actual-engine spell fixtures pass: '
                       ...
                       'CompetitiveGain': {'claim': 'Screen passed: 13.924% aggregate, '
                                                    'colors[19.16485244895416, 9.261897247362105],95% '
                                                    'interval[-4.071071941137228, 35.05441423453497]. '
                                                    'Independent different-roster confirmation failed: '
                                                    '-4.204% aggregate, colors[-13.349268001195092, '
                                                    '6.540153500561585],95% interval[-26.426299670174338, '
                                                    '24.2239080057715]. Exact-version fixed-roster scope, no '
                                                    'universal rank guarantee or per-component causal claim.',
                                           'status': 'contradicted',
                                           'evidence': [{'artifact': 'evidence/screen-report.json'},
                                                        {'artifact': 'evidence/confirmation-report.json'}]},
 ...
 'skill': {'portal_state': {'operator': 'adaptive_portal_state', 'parameters': {}},
           ...
           'observe': {'operator': 'adaptive_observe',
                       'parameters': {'scan_limit': 96, 'hero_priority_bonus': 480}},
 ...
 'execution': {'binding': 'gota-bassy/adaptive-score-2026-09-22-r1',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'bc5c83f92b43a0a37d4b879533584ff7b33c6e9e5e03cb06d6f4b08c501ac33c',
