POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'The new blue-Druid-only source must qualify on400fresh '
                                                    'blue later-draft games against current Druid source; '
                                                    'broad-study blue Druid results only generate this '
                                                    'hypothesis. Red and other heroes require complete local '
                                                    'command equivalence.',
 ...
 'execution': {'binding': 'gota-bassy/blue-druid-siege-2026-09-23-r2',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '14ea923cbd36dc0e7c535bb884847c98f404e51d1e5d5e1e4da3d530aa5a549e',
