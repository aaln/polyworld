"""Convert the current-game guarded siege semantic policy through its frozen binding."""
import argparse
import json
...
sys.path.insert(0, str(pair / 'tooling/bluesiege20260923'))
import blue_siege_binding
blue_siege_binding.configure()
ir = blue_siege_binding.ir
