POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'OpportunityMechanism': {'claim': 'On replay58,180 artificial host fixtures pass on '
                                                         'all ten classes/both colors, including '
                                                         'realized150XP hero kills and500XP god finishes. '
                                                         'Parent differs in60 intended choices. Complete '
                                                         'native games show changed XP allocation; hero XP '
                                                         'falls on red and rises on blue. Mechanism scope '
                                                         'only, no competitive score claim.',
                                                'status': 'supported',
                                                'evidence': [{'artifact': 'evidence/practice-r3-v2.json'},
                                                             {'artifact': 'evidence/practice-baseline-v2.json'},
                                                             {'artifact': 'evidence/native-summary.json'}]},
                       'PortalPreserved': {'claim': 'All84 existing portal fixtures pass on current replay58 '
                                                    'with the combined candidate;126 all-class/runtime '
                                                    'checks also pass. No claim that live aggregate recall '
                                                    'frequency is unchanged.',
                                           'status': 'supported',
                                           'evidence': [{'artifact': 'evidence/portals-r3.json'},
                                                        {'artifact': 'evidence/scenarios-r3.json'}]},
                       'CompetitiveGain': {'claim': 'The frozen160-game fresh-control comparison failed the '
                                                    '>=10% aggregate gain / >=95% each-color gate: -9.647% '
                                                    'gain, colors[10.231689852700487, '
                                                    '-22.642392630857444],95% bootstrap '
                                                    'interval[-25.648884922507598, 9.742789896282611]. Fixed '
                                                    'first-pick roster only; does not establish universal '
                                                    'superiority or rank.',
                                           'status': 'contradicted',
                                           'evidence': [{'artifact': 'evidence/hosted/report.json'},
                                                        {'artifact': 'evidence/hosted/result.json'}]},
                       'HostedAllocation': {'claim': 'Complete replay58 XP attribution separates '
                                                     'hero/creep/building/god rewards and elapsed time for '
                                                     'all160 games. Per-color means and uncertainty are '
                                                     'preserved; coordinated changes do not identify '
                                                     'component causality.',
                                            'status': 'supported',
                                            'evidence': [{'artifact': 'evidence/hosted/report.json'}]}}},
 ...
 'execution': {'binding': 'gota-bassy/score-opportunities-2026-09-22-r3',
               ...
               'language': 'BASIC'},
 'update': {'revision': 3,
            'parent': '33182eea497e84b8d43df3213e10aad72568a0e2b152ccacd3a140867e4bd40e',
            'change': {'origin': 'Completed fresh hosted comparison reflected into IR; executable unchanged',
