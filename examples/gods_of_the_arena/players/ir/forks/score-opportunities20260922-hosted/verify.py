...
r=read(pair/'evidence/hosted/report.json')
...
print(json.dumps({'passed':True,'source_sha256':m['source_sha256'],'ir_sha256':m['ir_sha256'],'hosted_complete':True,'score_gate_passed':m['score_gate_passed']}))
