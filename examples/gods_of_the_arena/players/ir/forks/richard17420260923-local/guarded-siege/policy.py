POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'The full new siege candidate must qualify independently '
                                                    'against the newly deployed Druid source; parent gains '
                                                    'do not validate this transfer.',
 ...
 'execution': {'binding': 'gota-bassy/guarded-siege-2026-09-23-r2',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'dd2e0b06cbefb1731819ffb5fe4bb920fda861ceb5f375f547c2fbf2c7462af8',
            'change': {'origin': 'Practiced coordinated behavior reflected into IR; frozen BASIC unchanged.'},
