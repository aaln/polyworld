"""Convert the crowd-control tactics semantic policy through its frozen binding."""
import argparse
import json
...
sys.path.insert(0, str(pair / 'tooling/controltactics20260923'))
import tactics_binding
