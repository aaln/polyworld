POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_control_tactics20260923',
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'validation. No opponent identity or private XP is used.'},
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'ControlMechanism': {'status': 'supported',
                                            'claim': '120matched real-tick fixtures verify useful hero '
                                                     'control during retreat, overlap guards, resource '
                                                     'legality and healing reserve. Warlock silence prevents '
                                                     'one scripted cast and saves42HP; Vanguard stun '
                                                     'saves38HP. Standard level2E unlock is identical to '
                                                     'baseline; no unlock benefit established. Native '
                                                     'twoWarlock cases gain502and949points; other six '
                                                     'unchanged. These tests do not isolate each component '
                                                     'or prove all-class league gains.',
                                            'evidence': [{'artifact': 'evidence/practice-comparison.json'}]},
                       'CompetitiveGain': {'status': 'supported',
                                           'claim': '80paired responsive hosted comparisons: '
                                                    'mean2429.512to2493.625, delta+64.112, '
                                                    'paired95%interval[2.0625, 135.0375]. Frozen pilot '
                                                    'advancement=True. Directional pilot only; no deployment '
                                                    'qualification or no-regression guarantee. Natural '
                                                    'subject classes are Ranger, Crossbowman and Druid; no '
                                                    'hosted Warlock/Vanguard/Lich efficacy claim.',
 ...
 'goal': {'Win': {'preference': 'No independent victory incentive. Enemy-god destruction supplies500 own XP '
          ...
          'Score': {'preference': 'Sole objective: maximize final individual max(0, lifetime XP*1440 '
                                  ...
                                  'this objective. Count avoided death and hero control only through '
                                  'resulting XP-minus-time; preserve farming and do not assume more control '
                                  'cannot regress scores.',
                    'provenance': 'authored'},
 ...
 'skill': {'portal_state': {'operator': 'cctactics_portal_state', 'parameters': {}},
           'draft': {'operator': 'cctactics_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'cctactics_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'cctactics_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'cctactics_timing', 'parameters': {}},
           'lifecycle': {'operator': 'cctactics_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'cctactics_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'cctactics_economy', 'parameters': {'shop_gold': 500}},
           'control_hero': {'operator': 'cctactics_control_hero', 'parameters': {}},
           'portal_context': {'operator': 'cctactics_portal_context', 'parameters': {}},
           'lane_recovery': {'operator': 'cctactics_lane_recovery', 'parameters': {}},
           'replenish': {'operator': 'cctactics_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'cctactics_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'cctactics_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'cctactics_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'cctactics_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'cctactics_xp_close', 'parameters': {}},
           'combat': {'operator': 'cctactics_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'cctactics_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/control-tactics-2026-09-23-r61a',
               'game_version': '2026.9.23.3',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'a68694a4627682f1a7e1380a0cc011067e66185b8ff3cb149daf695217452bf2',
            'change': {'origin': 'Reviewed exact tested control source after120pairedfixtures,16nativegames '
                                 'and80pairedhostedgames. Later user score-only steering applies to future '
                                 'studies; frozen gate preserved.',
                       'deployment_qualified': False},
            'needs_review': [],
            'evidence': [{'artifact': 'evidence/statistics.json'},
                         {'artifact': 'evidence/practice-comparison.json'},
                         {'artifact': 'evidence/native-comparison.json'},
                         {'artifact': 'evidence/score-objective-steering.json'}]}}
