POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'estimated lane counts do not assert eligibility. Release62 adds neutral '
                        'kind6/faction2, visible camp/leader/returning fields and public static camp '
                        'geometry. Returning mobs are immune. Camp life/respawn knowledge remains '
                        'visibility-limited. Lane XP sharing remains15percent last-hit reserve plus85percent '
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'CampMechanism': {'status': 'requires_review',
                                         'claim': '48 actual-host decision fixtures verify guarded pulling, '
                                                  'handoff, timeout, returning immunity and cancellation. '
                                                  'All40complete hosted own-source reconstructions match '
                                                  'every command and state hash: 39games select neutrals; '
                                                  '32games start74pulls. These observations do not isolate '
                                                  'the score effect of successful wave pulls from direct '
                                                  'neutral farming or unrelated combat changes.',
                                         'evidence': [{'artifact': 'evidence/practice-comparison.json'},
                                                      {'artifact': 'evidence/source-audit.json'},
                                                      {'artifact': 'evidence/statistics.json'}]},
                       'CurrentScoreGain': {'status': 'supported',
                                            'claim': 'Fresh replay62 discovery,40matched seeds: parent '
                                                     'mean2706.075, lane-only2353.150, lane-neutral3220.450. '
                                                     'Combined delta+514.375,97.5%interval[22.725, 972.2]; '
                                                     'incremental camp-vs-lane '
                                                     'delta+867.300,95%interval[348.65, 1368.25]. Combined '
                                                     'score pilot advance=True; no independent confirmation '
 ...
 'skill': {'portal_state': {'operator': 'neutralfarm_portal_state', 'parameters': {}},
           'draft': {'operator': 'neutralfarm_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'neutralfarm_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'neutralfarm_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'neutralfarm_timing', 'parameters': {}},
           'lifecycle': {'operator': 'neutralfarm_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'neutralfarm_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'neutralfarm_economy', 'parameters': {'shop_gold': 500}},
           'control_hero': {'operator': 'neutralfarm_control_hero', 'parameters': {}},
           'portal_context': {'operator': 'neutralfarm_portal_context', 'parameters': {}},
           'choose_lane': {'operator': 'neutralfarm_choose_lane', 'parameters': {}},
           'lane_recovery': {'operator': 'neutralfarm_lane_recovery', 'parameters': {}},
           'replenish': {'operator': 'neutralfarm_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'neutralfarm_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'neutralfarm_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'neutralfarm_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'neutralfarm_tower_safety', 'parameters': {'tower_hp': 65}},
           'neutral_farm': {'operator': 'neutralfarm_neutral_farm', 'parameters': {}},
           'xp_close': {'operator': 'neutralfarm_xp_close', 'parameters': {}},
           'combat': {'operator': 'neutralfarm_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'neutralfarm_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/lane-neutral-farming-2026-09-23-r62b',
               'game_version': '2026.9.23.4',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'a7bfae3297b269f66d6e1df5d55993a13d521e044f7ba0c2029428a9ea40c000',
            'change': {'origin': 'Reviewed neutral-camp update and prior lane coaching with a fresh matched '
                                 'release62 cohort; score-only rule. Invalid Jordan411 compilation cohort '
                                 'preserved in full. Tested BASIC unchanged.',
                       'deployment_qualified': False},
            'needs_review': ['belief/CampMechanism'],
            'evidence': [{'artifact': 'evidence/request.json'},
                         {'artifact': 'evidence/cohort-amendment.json'},
                         {'artifact': 'evidence/statistics.json'},
