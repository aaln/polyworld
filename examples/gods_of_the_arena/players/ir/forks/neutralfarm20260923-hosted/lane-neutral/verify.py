...
sys.path.insert(0,str(P/'tooling/neutralfarm20260923'))
...
assert not m['deployment_qualified'] and m['hosted_complete']
assert read(P/'evidence/statistics.json')['all_120_games_10_vms_valid']
