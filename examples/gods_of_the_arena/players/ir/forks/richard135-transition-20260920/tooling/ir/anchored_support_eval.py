from anchored_support import STUDY, VARIANTS, make
...
if __name__ == '__main__':
    freeze(STUDY/'screen-prospective.json', {'cases':12, 'seed':805000, 'variants':VARIANTS,
        'parent':'Corrected bound_idle22 caster policy, not pressure20 despite generic arm key.',
    ...
    evaluate('screen',VARIANTS,12,805000,make,STUDY,RUN/'r5/fast/audit-local')
    ...
    if q: main(study=STUDY,variants=['deployed','pressure_parent',*q],factory=make,seed=806000)
    else:
