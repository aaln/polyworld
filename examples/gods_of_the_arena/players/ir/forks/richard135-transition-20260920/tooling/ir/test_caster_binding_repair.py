...
from caster_binding_repair import make, VARIANTS, STUDY
...
class BoundTests(unittest.TestCase):
    ...
    def test_idle_variant_preserves_existing_wave_target(self):
        ...
        self.assertEqual(self.play('bound_idle', [first, case], ('bestId',))[-1]['memory']['bestId'], 1500)
        self.assertEqual(self.play('bound_focus', [first, case], ('bestId',))[-1]['memory']['bestId'], 106)
