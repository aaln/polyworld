from reachable_support import STUDY, VARIANTS, make
...
if __name__ == '__main__':
    freeze(STUDY/'screen-prospective.json', {'cases':12, 'seed':801000, 'variants':VARIANTS,
    ...
    evaluate('screen',VARIANTS,12,801000,make,STUDY,RUN/'r5/fast/audit-local')
    ...
    if q:main(study=STUDY,variants=['deployed','pressure_parent',*q],factory=make,seed=802000)
    else:
