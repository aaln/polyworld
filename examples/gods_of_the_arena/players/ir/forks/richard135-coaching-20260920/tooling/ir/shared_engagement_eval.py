from shared_engagement import STUDY, VARIANTS, make
...
if __name__ == '__main__':
    freeze(STUDY/'screen-prospective.json', {'cases': 12, 'seed': 791000, 'variants': VARIANTS,
    ...
    evaluate('screen', VARIANTS, 12, 791000, make, STUDY, RUN/'r5/fast/audit-local')
    ...
    if q: main(study=STUDY, variants=['deployed', 'pressure_parent', *q], factory=make, seed=792000)
    else:
