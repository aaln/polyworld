...
def register():
    contracts={
        'lineup_critical_cached_v1':observe_v2(target_work(CONTRACTS['lineup_critical_recall'])),
        'lineup_middle_cached_v1':fallback(CONTRACTS['lineup_middle_opening_v1']),
        'lineup_critical_cached_route_v1':fallback(CONTRACTS['lineup_perimeter_route'])}
