from ally_assist import STUDY, VARIANTS, make
...
if __name__ == '__main__':
    freeze(STUDY/'screen-prospective.json', {'cases': 12, 'seed': 793000, 'variants': VARIANTS,
    ...
    evaluate('screen', VARIANTS, 12, 793000, make, STUDY, RUN/'r5/fast/audit-local')
    ...
    if q: main(study=STUDY, variants=['deployed', 'pressure_parent', *q], factory=make, seed=794000)
    else:
