' Generated from gota_richard_coaching_formation2400_weapon; gota-semantic-policy/1; gota-basic/1
...
' @rule E2
if emptySlot <> 0 then
  if selfTeam = 1 or (1 = 1 and selfClass <> 7 and selfClass <> 8) then
    ownsfirst = 0
    ownssecond = 0
    ownsthird = 0
    ownsfourth = 0
