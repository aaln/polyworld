POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_attention_attention_current',
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'CurrentContract': {'claim': 'Use only the pinned current host/binding; historical '
                                                    'policy content and win-only gates are not active '
                                                    'constraints.',
                                           'status': 'supported',
                                           'evidence': [{'artifact': 'games/gods_of_the_arena/current.json'}]},
                       'Attention': {'claim': 'More frequent current observations improve XP score versus '
                                              'the current microplay parent without runtime failures.',
                                     'status': 'untested',
                                     'evidence': []},
                       'DraftAndMelee': {'claim': 'Ranged-first drafting and melee exposure require '
                                                  'verification in the supplied episode and clean '
                                                  'current-roster games.',
                                         'status': 'requires_review',
                                         'evidence': [{'artifact': 'tmp/gota-targets-20260922/user-episode'}]}}},
 'goal': {'Win': {'preference': 'Objective pressure supports XP production; fort outcomes are a diagnostic, '
                                'and the current league XP score is primary.',
                  'provenance': 'authored'},
          ...
          'Practice': {'preference': 'Secure feasible last hits and shared XP, buy useful permanent power, '
                       ...
                       'provenance': 'authored'}},
 'skill': {'draft': {'operator': 'micro_draft', 'parameters': {'think_ticks': 3}},
 ...
 'update': {'revision': 4,
            ...
            'change': {'origin': 'User requested continued XP/last-hit practice; test fresher creep '
                                 'observations under the VM margin',
                       'think_ticks': 3,
                       'scan_limit': 96},
            'needs_review': ['belief/CurrentContract', 'belief/Attention', 'belief/DraftAndMelee'],
            'evidence': []}}
