...
POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_targets20260922_melee_reserve',
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Public draft choices and visible enemy objects only. Current tower aggro and nearby '
                        ...
                        'proximity; Crossbowman attack range exceeds it. Current target identities are '
                        'evaluation metadata, never live policy inputs. Creep XP requires same floor and '
                        'six-tile proximity; Crossbowman attack range exceeds it.'},
 ...
 'strategy': [{'id': 'R_draft',
              ...
              {'id': 'R_advance',
               ...
               'skill': 'advance',
               'for': ['Win', 'Grow', 'Survive', 'Score', 'Practice']}],
 'execution': {'binding': 'gota-bassy/microplay-2026-09-22-r4',
               'game_version': '2026.9.21.5',
               'language': 'BASIC'},
 'update': {'revision': 3,
            'parent': '4e373db57442217ff54806146ae58338a69ef19cc9f22b420d89cf3ef4b2ef81',
            'change': {'origin': 'Broad armor reserve harmed native red performance; restrict the reserve to '
                                 'short-range heroes while preserving ranged mobility and test against '
                                 'practiced parent',
                       'variant': 'potions'},
