...
POLICY = {'schema': 'gota-semantic-policy/1',
 'id': 'gota_targets20260922_reserve',
 ...
 'strategy': [{'id': 'R_draft',
              ...
              {'id': 'R_advance',
               ...
               'skill': 'advance',
               'for': ['Win', 'Grow', 'Survive', 'Score', 'Practice']}],
 'execution': {'binding': 'gota-bassy/microplay-2026-09-22-r3',
               'game_version': '2026.9.21.5',
               'language': 'BASIC'},
 'update': {'revision': 3,
            'parent': '4e373db57442217ff54806146ae58338a69ef19cc9f22b420d89cf3ef4b2ef81',
            'change': {'origin': 'User asked to keep going: observed low-income heroes buy consumables while '
                                 'lacking armor; test an armor gold reserve against the practiced parent',
                       'variant': 'potions'},
