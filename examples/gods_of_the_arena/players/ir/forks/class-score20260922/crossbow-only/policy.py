POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'interrupts; a bot cannot cancel a channel by walking. Crossbow-only public spell '
                        'target and hero priority; original action paths for all other classes; no hidden '
                        'player identity or lifetime-XP input. Own lifetime XP is not exposed by this host '
                        'BASIC API.'},
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'OpportunityMechanism': {'claim': 'All160 actual-tick command/state conformance '
                                                         'scenes pass: Crossbowman matches the screened '
                                                         'intervention; nine other hero classes match the '
                                                         'deployed controller. Twenty full native games and '
                                                         'eight exact trajectory comparisons pass. This '
                                                         'validates branch behavior/runtime, not comparative '
                                                         'rival score.',
                                                'status': 'supported',
                       ...
                       'CompetitiveGain': {'claim': 'Screen failed: -6.345% aggregate, '
                                                    'colors[-31.94056754841138, 20.784484677598858],95% '
                                                    'interval[-23.501757972559766, 14.659776055124896]. No '
 ...
 'skill': {'portal_state': {'operator': 'class_portal_state', 'parameters': {}},
           'draft': {'operator': 'class_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'class_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'class_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'class_timing', 'parameters': {}},
           'lifecycle': {'operator': 'class_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'class_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'class_economy', 'parameters': {'shop_gold': 500}},
           'portal_context': {'operator': 'class_portal_context', 'parameters': {}},
           'replenish': {'operator': 'class_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'class_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'class_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'class_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'class_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'class_xp_close', 'parameters': {}},
           'combat': {'operator': 'class_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'class_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/class-score-2026-09-22-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '2e76719121958910272577a645b54a45ca668744c1d4063d7c66373a3a72a199',
