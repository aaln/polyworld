POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'A fresh four-context320game comparison must show '
                                                    'improved individual score, preserve both '
                                                    'colors/lead/later draft, and satisfy the frozen '
                                                    'deployment rule. Local checks cannot qualify promotion.',
 ...
 'execution': {'binding': 'gota-bassy/lane-recovery-2026-09-23-r1',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'b422a2bd92c01707ff42acadbe11f4588cb991c6cc7223646827f42591e98d2a',
            'change': {'origin': 'Validated local behavior reflected into semantic IR; generated BASIC '
                                 'unchanged.'},
