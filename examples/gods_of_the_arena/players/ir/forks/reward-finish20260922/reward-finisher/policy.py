POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'OpportunityMechanism': {'claim': 'All140 actual-tick target/reward scenes pass '
                       ...
                       'CompetitiveGain': {'claim': '400-game fresh held-out trial passed: 12.438% '
                                                    'aggregate, colors [22.286992532472926, '
                                                    '4.014437608904364],95% interval [0.08367562863640376, '
                                                    '26.408517904675797]. Gate requires >=10%aggregate, '
                                                    '>=95%eachcolor and positive lower95%bound, zero '
                                                    'invalid. Field-stable deployment qualification: False. '
