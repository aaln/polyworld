...
STUDY = Path(__file__).resolve().parents[5] / 'polyworld/tmp/gota-balance-20260922'
PAGE = '''<!doctype html><meta charset="utf-8"><title>GOTA balance tests</title>
...
<h1>GOTA — symmetry and hero balance</h1><p class="note">2026.9.22.2 · 40 games per hero preference and color · XP score is primary</p>
...
if __name__ == '__main__':
    ThreadingHTTPServer(('127.0.0.1', 8850), Handler).serve_forever()
