"""Convert the draft-only current-game semantic policy through its frozen binding."""
import argparse
import json
...
sys.path.insert(0, str(pair / 'tooling/productive20260923'))
import finish_binding
