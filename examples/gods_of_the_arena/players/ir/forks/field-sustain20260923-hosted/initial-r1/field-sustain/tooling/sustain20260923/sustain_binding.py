...
VERSION = 'gota-bassy/field-sustain-2026-09-23-r1'
...
''', {}, (), (), ('castTarget',), 'Recompute field danger and fountain need each decision. No enemy hero within10tiles, creep within6, enemy tower within10/targeting us, or near imminent warning; overflow is unsafe. Cast the strongest learned ready charged affordable self-heal below75%HP even while escaping danger. Wait at most18ticks for the accepted heal (current self-heals impact within12); do not infer success from availability or cooldown. No ready/active heal means no sustain hold.', ('sustainUntil', 'retreat'))
