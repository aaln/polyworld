' Generated from gota_field_sustain20260923; gota-semantic-policy/1; gota-bassy/field-sustain-2026-09-23-r1
...
' @rule R_retreat_release
if active = 1 and inBase = 0 and retreat = 1 and restock = 0 and sustainSafe = 1 and selfHp * 100 >= selfMaxHp * 75 and selfMana * 100 >= selfMaxMana * 20 then
  retreat = 0
...
' @rule R_field_sustain_and_push
if active = 1 and inBase = 0 and canSustain = 1 and restock = 0 and selfHp * 100 < selfMaxHp * 75 then
  baseFountainRequired = 0
  resumeTarget = 0
  if selfRootTicks = 0 then
    sustainX = selfX
