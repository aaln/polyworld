POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Coached home recall differs from outbound tower travel. in_base=canShop, '
                        ...
                        'Source/episode unbound; visual facts and unverified Gemini details separated in '
                        'coaching-review. Learned ready affordable self-heal, bounded accepted-cast window '
                        'and current public threat guards ground can_sustain_in_lane. All hero classes use '
                        'live ability observations.'},
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                                                  'claim': 'Reviewed recording shows Druid recovery and '
                                                           'continued homeward travel. Episode/source '
                                                           'unbound and playback is scrubbed; exact Gemini '
                                                           'HP values and elapsed-time claims are not '
                                                           'accepted. Current source independently contains '
                                                           'a fountain-only retreat latch.',
                                                  'evidence': [{'artifact': 'evidence/coaching-review.json'}]},
                       'RecoveryMechanism': {'status': 'requires_review',
                                             'claim': 'Actual-engine practice verifies accepted self-heals, '
                                                      'field retreat termination and same-decision path '
                                                      'cancellation with resource/threat/channel/restock '
                                                      'guards. No cooldown waiting or unsafe premature '
                                                      'return.',
                                             'evidence': [{'artifact': 'evidence/practice.json'}]},
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'Coordinated sustain and retreat-controller changes '
                                                    'improve held-out individual score while preserving blue '
                                                    'lead ranged performance and both late-draft color '
                                                    'contexts. Local healing success is not a score claim.',
 ...
 'execution': {'binding': 'gota-bassy/field-sustain-2026-09-23-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 1,
            'parent': '8886044384594a4fd1d50d0524545c3dd87265f06cebba623a1214aa1bfdb021',
            'change': {'origin': 'User coaching session2026-09-23t02-52-57-098ze03810; coordinate situation, '
                                 'belief, goals, strategy, healing and interruptible recovery control.'},
            'needs_review': ['belief/RecoveryMechanism', 'belief/CompetitiveGain'],
            'evidence': [{'artifact': 'evidence/session-input-manifest.json'},
