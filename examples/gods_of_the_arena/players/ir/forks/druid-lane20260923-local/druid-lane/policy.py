POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CoachingInterpretation': {'status': 'supported',
                       ...
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'A fresh400game natural later-draft comparison must '
                                                    'improve score, preserve both colors and satisfy the new '
                                                    'frozen rule; non-Druid commands must equal the deployed '
                                                    'baseline. Local checks cannot qualify promotion.',
 ...
 'execution': {'binding': 'gota-bassy/druid-lane-recovery-2026-09-23-r1',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'd61b2b243c143321afded3601f5d5b96a925fe24511f95267a52353c8506ddbb',
