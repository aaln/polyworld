POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'execution': {'binding': 'gota-bassy/score-opportunities-2026-09-22-r3',
               ...
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '6b47b0991c5915d768e45a1285708e4388ac9218c96719037be2ff5280c52a98',
            'change': {'origin': 'Validated local behavior and current-engine calibration reflected into IR; '
                                 'source unchanged. Hosted comparison prepared, not run.'},
            'needs_review': ['belief/CompetitiveGain'],
            'evidence': [{'artifact': 'evidence/experiment.md'},
                         {'artifact': 'evidence/calibration58.json'},
