POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'goal': {'Win': {'preference': 'No independent victory incentive. Structures are fallback XP/access '
                                'opportunities; do not prefer a fort over reachable profitable living '
                                'targets. Do not idle merely to lengthen games.',
                  'provenance': 'authored'},
          ...
          'Score': {'preference': 'Sole objective: maximize final individual max(0, lifetime XP*1440 '
                                  ...
                                  'building100XP. Prefer productive kills and farming; elapsed time always '
                                  'costs200/minute. Fort wins, survival, items and portals matter only '
                                  'through their contribution to this objective.',
                    'provenance': 'authored'},
 ...
 'execution': {'binding': 'gota-bassy/score-opportunities-2026-09-22-r1',
