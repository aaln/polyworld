POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'situation': {'grounded': {'observation': 'Bassy Q16.16 decimals for fractional action coordinates, integer '
               ...
               'notes': 'Public patched-host observations only. Experiment uses one subject seat and nine '
                        ...
                        'realized-pick splits are descriptive. Retained control uses global coordinates; '
                        'mirrored alternatives are kept with their results.'},
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'CurrentRuntime': {'claim': 'Exact source completed 80 games on 2026.9.22.2, both '
                       ...
                       'FrozenScoreGate': {'claim': 'This executable is the fresh patched-engine comparison '
                                                    'control; being retained does not establish superiority '
