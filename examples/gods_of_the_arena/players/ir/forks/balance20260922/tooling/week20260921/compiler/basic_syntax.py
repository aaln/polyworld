"""Fail-closed parser for the structured scalar Bassy BASIC emitted by this binding.

This is a structural reader, not a second runtime. Precedence follows the scalar operators in pinned Bassy. Decimal literals and
integer division are supported; execution is checked in the actual game VM.
"""
