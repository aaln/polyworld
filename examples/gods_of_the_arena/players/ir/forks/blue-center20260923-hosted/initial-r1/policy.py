POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'RouteMechanism': {'status': 'requires_review',
                                          'claim': 'The first blue ranged hero advances toward center when '
                                                   'no combat/recovery/defense rule preempts. All other '
                                                   'classes, ordinals and red behavior remain unchanged.',
                                          'evidence': [{'artifact': 'evidence/practice.json'}]},
                       'InheritedMechanics': {'status': 'requires_review',
                                              'claim': 'Current buyback, portal recovery and combat '
                                                       'mechanisms remain valid on the exact engine.',
                                              'evidence': [{'artifact': 'evidence/local-summary.json'}]},
                       'CompetitiveGain': {'status': 'requires_review',
                                           'claim': 'A fresh 400-game comparison improves blue individual '
                                                    'score and closes the khors114 score gap while passing '
                                                    'aggregate and red-preservation gates. Earlier central '
                                                    'contact alone is not success.',
 ...
 'execution': {'binding': 'gota-bassy/blue-center-2026-09-23-r1',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 1,
            'parent': 'c1a5839bcfe2c4a155f6ee76de78fb6a86d59601e1e051dafe62bac5bb7b5b20',
            'change': {'origin': 'User requests blue improvement against khors114. Prior 100 blue games lose '
                                 'hero-kill XP despite higher creep XP; all four prospectively sampled blue '
                                 'openings remain level1 at one minute while khors is level2/3.'},
            'needs_review': ['belief/RouteMechanism', 'belief/InheritedMechanics', 'belief/CompetitiveGain'],
