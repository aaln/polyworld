POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
                         ...
                         'uncertainty': 'Unseen enemies are unknown. Visible targets may be masked. Only the '
                                        ...
                                        'choices.'},
            'claims': {'RouteMechanism': {'status': 'supported',
                                          'claim': 'All100 actual opening contexts pass across ten '
                                                   'classes/two teams/five ordinals; two full native red '
                                                   'command streams and terminal states match the parent. '
                                                   'Only blue lead ranged advance and immediate critical '
                                                   'keep recovery change. This proves bounded command '
                                                   'semantics, not competitive strength.',
                                          'evidence': [{'artifact': 'evidence/practice.json'},
                                                       {'artifact': 'evidence/red-equivalence.json'}]},
                       'InheritedMechanics': {'status': 'supported',
                                              'claim': 'All180 buyback,84portal,126broader host checks '
                                                       'and8complete native games pass on the frozen engine. '
                                                       'Route-only r1 failed2portal cases and is separately '
                                                       'preserved; r2 fixes the recovery handoff. Native '
                                                       'score does not qualify competitive deployment.',
                                              'evidence': [{'artifact': 'evidence/local-summary.json'}]},
                       'CompetitiveGain': {'status': 'supported',
                                           'claim': '400 fresh games: aggregate 15.682%, colors '
                                                    '[-3.06867372464541, 40.739830548143985], aggregate95%CI '
                                                    '[3.1625349204718267, 29.562932776372854], blue95%CI '
                                                    '[18.741609490175804, 66.33506504658453], blue mean gap '
                                                    'to khors114 1266.72. Original '
                                                    'aggregate/red/blue/confidence and field qualification: '
                                                    'True. Fixed first-team-seat mixed roster; no permanent '
                                                    'rank, later-draft or separate-component causality.',
 ...
 'skill': {'portal_state': {'operator': 'bluecenter_portal_state', 'parameters': {}},
           'draft': {'operator': 'bluecenter_draft', 'parameters': {'think_ticks': 6}},
           'recovery_intent': {'operator': 'bluecenter_recovery_intent', 'parameters': {}},
           'base_recovery_intent': {'operator': 'bluecenter_base_recovery_intent', 'parameters': {}},
           'timing': {'operator': 'bluecenter_timing', 'parameters': {}},
           'lifecycle': {'operator': 'bluecenter_lifecycle',
                         'parameters': {'buyback_seconds': 25, 'buyback_reserve': 200}},
           'observe': {'operator': 'bluecenter_observe', 'parameters': {'scan_limit': 96}},
           'economy': {'operator': 'bluecenter_economy', 'parameters': {'shop_gold': 500}},
           'portal_context': {'operator': 'bluecenter_portal_context', 'parameters': {}},
           'replenish': {'operator': 'bluecenter_replenish', 'parameters': {}},
           'channel_town_scroll': {'operator': 'bluecenter_channel_town_scroll', 'parameters': {}},
           'walk_to_base': {'operator': 'bluecenter_walk_to_base', 'parameters': {}},
           'home_portal': {'operator': 'bluecenter_home_portal', 'parameters': {}},
           'tower_safety': {'operator': 'bluecenter_tower_safety', 'parameters': {'tower_hp': 65}},
           'xp_close': {'operator': 'bluecenter_xp_close', 'parameters': {}},
           'combat': {'operator': 'bluecenter_combat', 'parameters': {'reset_recovery': 1}},
           'advance': {'operator': 'bluecenter_advance', 'parameters': {}}},
 ...
 'execution': {'binding': 'gota-bassy/blue-center-2026-09-23-r2',
               'game_version': '2026.9.22.3',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': 'f82ba63ee0fde1ce84496f9e8aec94c234811d3dea0452d4ad15dd3a717df1f2',
            'change': {'origin': 'Completed local and hosted evidence reflected into IR; frozen executable '
                                 'bytes unchanged',
