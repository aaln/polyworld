POLICY = {'schema': 'gota-semantic-policy/1',
 ...
 'belief': {'grounded': {'memory': ['crossed',
            ...
            'claims': {'PortalPattern': {'claim': 'All16 preselected baseline diagnostic games contain a '
                       ...
                       'CoachingFidelity': {'claim': 'The combined controller passes84 actual-tick portal '
                                                     'fixtures on both colors plus126 all-class checks. Four '
                                                     'complete candidate games eliminate six matched-control '
                                                     'keep-to-home portals and complete all12 channels. '
                                                     'These are mechanism/runtime observations, not proof of '
                                                     'competitive gain. In160 fresh audited hosted games, '
                                                     'keep-to-home portal starts are1 in80 candidate games '
                                                     'versus107 in80 controls. Hosted score improvement is '
                                                     'assessed separately.',
                                            'status': 'supported',
                                            'evidence': [{'artifact': 'evidence/candidate-r3-practice-v4.json'},
                                                         {'artifact': 'evidence/native-result.json'},
                                                         {'artifact': 'evidence/review.json'},
                                                         {'artifact': 'evidence/hosted/report.json'}]},
                       'CompetitiveGain': {'claim': 'The fixed160-game fresh-control study passed its '
                                                    'prospective >=10% mean-score gain and >=95% each-color '
                                                    'preservation gate: 11.56% overall. The95% bootstrap '
                                                    'gain interval is[-7.754978877489438, '
                                                    '34.75494130922878]; this does not establish confident '
                                                    'generalization or league rank.',
                                           'status': 'supported',
                                           'evidence': [{'artifact': 'evidence/hosted/result.json'}]},
                       'KhorsSuperiority': {'claim': 'On the fixed first-pick mixed roster, the candidate '
                                                     'exceeds khors:v114 mean individual XP score by at '
                                                     'least10% on both colors with a positive95% bootstrap '
                                                     'lower bound. This is separate from team wins or a '
                                                     'leaderboard-rank guarantee.',
 ...
 'strategy': [{'id': 'R_portal_state',
              ...
              {'id': 'R_advance',
               ...
               'skill': 'advance',
               'for': ['Grow', 'Survive', 'Score', 'Practice', 'survive_and_replenish']}],
 'execution': {'binding': 'gota-bassy/portals-2026-09-22-r3',
               'game_version': '2026.9.22.2',
               'language': 'BASIC'},
 'update': {'revision': 2,
            'parent': '5575207f887b204b90888b2db9a4579f43aa6c5dcaf2aba07ffbd55108271c88',
            'change': {'origin': 'Validated portal coaching feedback; preserve exact candidate source',
                       'hosted_complete': True},
            'needs_review': ['belief/KhorsSuperiority'],
