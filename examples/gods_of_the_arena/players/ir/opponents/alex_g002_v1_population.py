...
MODEL = {'schema': 'gota-semantic-opponent/1',
 'id': 'alex_g002_v1_population_observer_model',
 ...
 'belief': {'grounded': {'level': 'population',
            ...
            'claims': {'AlexG002v1_P_O03': {'claim': 'WHEN nearby=our hero; no nearby creep/exposed '
                                                     'structure; visible HP >100 THEY PREFER hold OVER '
                                                     'target_hero FOR unresolved (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O03',
                                                          'when': 'mask_1_low_0',
                                                          'skill': 'hold',
                                                          'over': 'target_hero',
                                                          'n': 307,
                       ...
                       'AlexG002v1_P_O04': {'claim': 'WHEN nearby=our hero; no nearby creep/exposed '
                                                     'structure; visible HP ≤100 THEY PREFER hold OVER '
                                                     'withdraw FOR unresolved (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O04',
                                                          'when': 'mask_1_low_1',
                                                          'skill': 'hold',
                                                          'over': 'withdraw',
                                                          'n': 60,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O05': {'claim': 'WHEN nearby=our creep; no nearby hero/exposed '
                                                     'structure; visible HP >100 THEY PREFER target_creep '
                                                     'OVER hold FOR creep_contact (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O05',
                                                          'when': 'mask_2_low_0',
                                                          'skill': 'target_creep',
                                                          'over': 'hold',
                                                          'n': 334,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O06': {'claim': 'WHEN nearby=our creep; no nearby hero/exposed '
                                                     'structure; visible HP ≤100 THEY PREFER target_creep '
                                                     'OVER withdraw FOR creep_contact (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O06',
                                                          'when': 'mask_2_low_1',
                                                          'skill': 'target_creep',
                                                          'over': 'withdraw',
                                                          'n': 3,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O07': {'claim': 'WHEN nearby=our hero + our creep; no nearby exposed '
                                                     'structure; visible HP >100 THEY PREFER target_creep '
                                                     'OVER hold FOR creep_contact (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O07',
                                                          'when': 'mask_3_low_0',
                                                          'skill': 'target_creep',
                                                          'over': 'hold',
                                                          'n': 1028,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O08': {'claim': 'WHEN nearby=our hero + our creep; no nearby exposed '
                                                     'structure; visible HP ≤100 THEY PREFER hold OVER '
                                                     'target_creep FOR unresolved (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O08',
                                                          'when': 'mask_3_low_1',
                                                          'skill': 'hold',
                                                          'over': 'target_creep',
                                                          'n': 68,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O09': {'claim': 'WHEN nearby=our exposed structure; no nearby '
                                                     'hero/creep; visible HP >100 THEY PREFER '
                                                     'target_structure OVER hold FOR structure_pressure '
                                                     '(goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O09',
                                                          'when': 'mask_4_low_0',
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O10': {'claim': 'WHEN nearby=our exposed structure; no nearby '
                                                     'hero/creep; visible HP ≤100 THEY PREFER hold OVER '
                                                     'target_structure FOR unresolved (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O10',
                                                          'when': 'mask_4_low_1',
                                                          'skill': 'hold',
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O11': {'claim': 'WHEN nearby=our hero + our exposed structure; no '
                                                     'nearby creep; visible HP >100 THEY PREFER target_hero '
                                                     'OVER target_structure FOR hero_pressure (goal '
                                                     'hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O11',
                                                          'when': 'mask_5_low_0',
                                                          'skill': 'target_hero',
                                                          'over': 'target_structure',
                                                          'n': 122,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O12': {'claim': 'WHEN nearby=our hero + our exposed structure; no '
                                                     'nearby creep; visible HP ≤100 THEY PREFER hold OVER '
                                                     'target_hero FOR unresolved (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O12',
                                                          'when': 'mask_5_low_1',
                                                          'skill': 'hold',
                                                          'over': 'target_hero',
                                                          'n': 9,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O13': {'claim': 'WHEN nearby=our creep + our exposed structure; no '
                                                     'nearby hero; visible HP >100 THEY PREFER target_creep '
                                                     'OVER target_structure FOR creep_contact (goal '
                                                     'hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O13',
                                                          'when': 'mask_6_low_0',
                                                          'skill': 'target_creep',
                                                          'over': 'target_structure',
                                                          'n': 371,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O14': {'claim': 'WHEN nearby=our creep + our exposed structure; no '
                                                     'nearby hero; visible HP ≤100 THEY PREFER target_creep '
                                                     'OVER target_structure FOR creep_contact (goal '
                                                     'hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O14',
                                                          'when': 'mask_6_low_1',
                                                          'skill': 'target_creep',
                                                          'over': 'target_structure',
                                                          'n': 14,
                                                          ...
                                                          'predictions': {'n': 0,
                                                                          ...
                                                                          'accuracy': None,
                                                                          'population_accuracy': None}}]},
                       'AlexG002v1_P_O15': {'claim': 'WHEN nearby=our hero + our creep + our exposed '
                                                     'structure; visible HP >100 THEY PREFER target_creep '
                                                     'OVER target_hero FOR creep_contact (goal hypothesis).',
                                            'status': 'requires_review',
                                            'evidence': [{'id': 'AlexG002v1_P_O15',
                                                          'when': 'mask_7_low_0',
                                                          'skill': 'target_creep',
                                                          'over': 'target_hero',
                                                          'n': 84,
 ...
 'goal': {'hero_pressure': {'preference': 'Hypothesis: maintain visible hero contact in the counted '
                            ...
                            'supporting_preferences': ['AlexG002v1_P_O11', 'AlexG002v1_P_O16'],
          ...
          'creep_contact': {'preference': 'Hypothesis: maintain creep contact. XP, gold and last-hit '
                            ...
                            'provenance': 'interpretation',
                            'supporting_preferences': ['AlexG002v1_P_O05',
                                                       'AlexG002v1_P_O06',
                                                       'AlexG002v1_P_O07',
                                                       'AlexG002v1_P_O13',
                                                       'AlexG002v1_P_O14',
          ...
          'structure_pressure': {'preference': 'Hypothesis: pressure exposed structures. Target selection is '
                                 ...
                                 'provenance': 'interpretation',
                                 'supporting_preferences': ['AlexG002v1_P_O09'],
          ...
          'unresolved': {'preference': 'Goal unknown: stationary motion alone does not establish voluntary '
                                       'holding.',
                         'provenance': 'interpretation',
                         'supporting_preferences': ['AlexG002v1_P_O03',
                                                    'AlexG002v1_P_O04',
                                                    'AlexG002v1_P_O08',
                                                    'AlexG002v1_P_O10',
                                                    'AlexG002v1_P_O12'],
 ...
 'strategy': [{'id': 'AlexG002v1_P_O03', 'when': 'mask_1_low_0', 'skill': 'hold', 'for': ['unresolved']},
              {'id': 'AlexG002v1_P_O04', 'when': 'mask_1_low_1', 'skill': 'hold', 'for': ['unresolved']},
              {'id': 'AlexG002v1_P_O05',
               'when': 'mask_2_low_0',
               'skill': 'target_creep',
               'for': ['creep_contact']},
              ...
              {'id': 'AlexG002v1_P_O07',
               ...
               'skill': 'target_creep',
               'for': ['creep_contact']},
              {'id': 'AlexG002v1_P_O08', 'when': 'mask_3_low_1', 'skill': 'hold', 'for': ['unresolved']},
              {'id': 'AlexG002v1_P_O09',
               'when': 'mask_4_low_0',
               'skill': 'target_structure',
               'for': ['structure_pressure']},
              {'id': 'AlexG002v1_P_O10', 'when': 'mask_4_low_1', 'skill': 'hold', 'for': ['unresolved']},
              {'id': 'AlexG002v1_P_O11',
               'when': 'mask_5_low_0',
               'skill': 'target_hero',
               'for': ['hero_pressure']},
              {'id': 'AlexG002v1_P_O12', 'when': 'mask_5_low_1', 'skill': 'hold', 'for': ['unresolved']},
              {'id': 'AlexG002v1_P_O13',
               'when': 'mask_6_low_0',
               'skill': 'target_creep',
               'for': ['creep_contact']},
