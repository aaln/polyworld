...
def grounded(policy):
    ...
    return {
        ...
        "belief": {
            ...
            "uncertainty": ("Unseen enemies are unobserved. Visible object target IDs are exposed; zero can mean no target or a target outside visibility. Future enemy intentions remain unknown." if policy["execution"]["game_version"] == "2026.9.15.3" else "Unseen enemies are unobserved. Tower targets and enemy intentions are not exposed."),
        },
